            ...
            <div class="body">
                <div class="address">
                    ...
                    <!--新增功能-->                       
                        ...
                        <button @click="gotolink" class="btn btn-success">新增收货地址</button>
                        <tan-button primary width="170px" height="48px" @click="$router.push({ name: 'index' })">新增收货地址</tan-button>
...
//新增
import addressAddVue from "../components/address-add.vue"
//新增结束
